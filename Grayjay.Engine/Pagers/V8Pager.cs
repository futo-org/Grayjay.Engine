...
namespace Grayjay.Engine.Pagers
{
    public class V8Pager<T> : IPager<T>
    {
        ...
        public V8Pager(GrayjayPlugin plugin, IJavaScriptObject jobj, Action<T>? objectInitializer)
        {
            ...
            _hasMorePages = (bool?)jobj.InvokeV8(_plugin.Config, "hasMorePagers") ?? false;
            UpdateResults();
        }
        ...
        public virtual void NextPage()
        {
            try
            {
                var obj = _obj.InvokeV8(_plugin.Config, "nextPage");
        ...
        protected void UpdateResults()
        {
            ...
            _hasMorePages = (bool?)_obj.InvokeV8(_plugin.Config, "hasMorePagers") ?? false;
        }
